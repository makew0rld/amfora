...
func Init() error {
	...
	viper.SetDefault("keybindings.bind_reload", []string{"Rune:R", "Ctrl-R"})
	...
	viper.SetDefault("keybindings.bind_pgup", []string{"PgUp", "Rune:u"})
	viper.SetDefault("keybindings.bind_pgdn", []string{"PgDn", "Rune:d"})
	viper.SetDefault("keybindings.bind_bottom", "Rune: ")
	viper.SetDefault("keybindings.bind_edit", "Rune:e")
	viper.SetDefault("keybindings.bind_back", []string{"Rune:b", "Alt:Left"})
	viper.SetDefault("keybindings.bind_forward", []string{"Rune:f", "Alt:Right"})
	...
	viper.SetDefault("keybindings.bind_quit", []string{"Ctrl-C", "Ctrl-Q", "Rune:q"})
