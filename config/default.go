...
# * Ctrl- isn't a universal modifier, just the keys listed in tcell.KeyNames, see:
# https://github.com/gdamore/tcell/blob/master/key.go (it was line 83 when this comment was written)
...
#bind_bottom = "Space"
#bind_edit = "e"
#bind_back = ["b","Alt-Left"]
#bind_forward = ["f","Alt-Right"]
#bind_new_tab = "Ctrl-T"
